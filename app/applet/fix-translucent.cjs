...
replaceFile('src/components/ExpensesTab.tsx', [
  [/bg-rose-50\/45/g, 'bg-[#1a0e0d]'],
  [/border-rose-100/g, 'border-rose-500/20'],
  [/text-rose-700/g, 'text-rose-500'],
  
  [/bg-emerald-50\/45/g, 'bg-[#1a0e0d]'],
  [/border-emerald-100/g, 'border-emerald-500/20'],
  [/text-emerald-700/g, 'text-emerald-500'],
  
  [/bg-amber-50\/45/g, 'bg-[#1a0e0d]'],
  [/border-\[#ff7a00\]\/30/g, 'border-[#ff7a00]/20'],
  [/text-amber-700/g, 'text-[#ff7a00]'],
]);

replaceFile('src/components/ReportsTab.tsx', [
  [/bg-amber-50\/70/g, 'bg-[#1a0e0d]'],
  [/border-\[#ff7a00\]\/30/g, 'border-[#ff7a00]/20'],
  [/text-amber-700/g, 'text-[#ff7a00]'],
  
  [/bg-emerald-50\/70/g, 'bg-[#1a0e0d]'],
  
  [/bg-sky-50\/70/g, 'bg-[#1a0e0d]'],
  
  [/bg-rose-50\/70/g, 'bg-[#1a0e0d]'],
...
console.log('Fixed translucent backgrounds!');
